public class WebViewStronger extends WebView {
    ...
    public WebViewStronger(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context);
    }

    public WebViewStronger(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public WebViewStronger(Context context) {
        super(context);
        init(context);
    }
    ...
    private void injectJavascriptInterfaces(WebView webView) {
        if (webView instanceof WebViewStronger) {
            injectJavascriptInterfaces();
        }
    }
    ...
    private String genJavascriptInterfacesString() {
         ...
         * prompt(
         * 'App:'+JSON.stringify({obj:'XXX_js_interface_name',func:'XXX_',args:[arg0,arg1]}));
         * }, }; } })()
         */
    ...
    private class WebChromeClientEx extends WebChromeClient {
        ...
        @Override
        public final boolean onJsPrompt(WebView view, String url, String message, String defaultValue,
                                        JsPromptResult result) {
            if (view instanceof WebViewStronger) {
    ...
    protected void onSizeChanged(int w, int h, int ow, int oh) {
        ...
        if (mOnSizeChangedListener != null) {
            if (h != 0) {
                mOnSizeChangedListener.getSize(h);
            }
        }
    }
    ...
    public interface OnSizeChangedListener {
        public void getSize(int height);
    }
}
