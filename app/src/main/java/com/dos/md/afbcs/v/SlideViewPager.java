...
public class SlideViewPager extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        // adding and removing different arbitrary任意的 views and do not
...
//每个子child的宽度为屏幕的宽度减去与两边的间距
        ...
        mSwitchSize = width;//切换一个page需要移动的距离为一个page的宽度
        confirmScaleRatio(width, mGutterSize); //确定缩放比例
    }
    ...
    //private static final int MARGIN_LEFT_RIGHT = 150;    private float mOriginalX = 0.0f;    private int mCloseEnough;
    //private static final int MARGIN_TOP_BOTTOM = 400;    private static final String TAG = SlideViewPager.class.getSimpleName();
    ...
    public SlideViewPager(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ScaleViewPager, 0, 0);
         /* marginLeftRight是确定子View与left和right间距，gutterSize是确定原始大小子View与缩小子View间离 */
